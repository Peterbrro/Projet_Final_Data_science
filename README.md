...
L'objectif est de prédire les mouvements du marché à 15 minutes et d'optimiser les prises de position via un agent de Reinforcement Learning (PPO).

Données : 2022 (Train), 2023 (Val), 2024 (Test final).
